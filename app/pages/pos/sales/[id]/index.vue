  ...
  <VContainer :fluid="true">
    <VRow density="compact">
      <VCol md="8" cols="12" class="mx-auto">
        <VCard id="psid-main-card" class="pa-4" variant="outlined">
          <!-- Header -->
          <div class="d-flex align-center mb-4">
            <VIcon start class="mr-2" color="primary">mdi-receipt</VIcon>
            <div>
            ...
            <VSpacer />
            <VChip size="small" text-color="white" :color="statusColor" class="font-weight-bold">
              {{ statusLabel }}
            </VChip>
          </div>
          ...
          <div class="d-flex justify-end">
            <VBtn id="psid-back-btn" color="grey" variant="outlined" @click="goBack">
