<template>
  <VDialog id="tes-dialo-dlg-1" :model-value="true" persistent max-width="600px">
    <VCard>
      ...
      <div class="d-flex justify-end px-4 pb-4">
        <VBtn id="tes-dialog-cancel-btn" color="primary" variant="outlined" class="mr-4" :disabled="saving || loading" @click="close">
