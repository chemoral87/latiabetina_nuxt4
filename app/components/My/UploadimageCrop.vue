<template>
  <div id="cmp-my-uploadimage-crop">
    ...
    <VBtn
      id="my-uploadimagecrop-pick-btn"
      size="small"
      color="primary"
      :loading="loading"
    ...
    <div
      ...
      class="d-flex align-center justify-center mt-2 bg-grey-lighten-3 rounded"
    >
    ...
    <div v-else-if="filename" class="d-flex align-center mt-2">
      ...
      <VBtn
        id="my-uploadimagecrop-clear-btn"
        size="small"
        color="error"
        variant="outlined"
        @click="clearImage"
    ...
    >
      ...
      <span class="text-caption mt-1" :class="dragOver ? 'text-primary' : 'text-grey'"
        >Arrastra el archivo aquí</span
      >
    </div>
    ...
    <VDialog id="my-uploa-dlg-1" v-model="dialog" persistent max-width="520px">
      <VCard>
          ...
          <VRow density="compact">
            ...
            <VCol cols="6">
              <div
                ...
                class="d-flex align-center justify-center bg-grey-lighten-4 rounded-circle"
              >
                <img
                  :src="imageToUpload"
                  style="max-width: 100%; min-height: 120px; border-radius: 50%"
                />
              </div>
              <div
                v-else
                style="width: 160px; height: 160px"
                class="d-flex align-center justify-center bg-grey-lighten-3 rounded-circle"
              >
        ...
        <div class="d-flex justify-end px-4 pb-4">
          <VBtn
            id="my-uploadimagecrop-cancel-btn"
            class="mr-4"
            color="primary"
            variant="outlined"
            @click="cancel()"
  ...
  function fileInputChange(file: File) {
    ...
    imgLoader.onload = function () {
      const ratio = Math.sqrt(
        (imgLoader.width * imgLoader.height) / (maxSize.value * maxSize.value)
      )
      let _maxSize =
        imgLoader.width > imgLoader.height ? imgLoader.width / ratio : imgLoader.height / ratio
