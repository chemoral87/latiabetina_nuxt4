  ...
  <VDialog id="dlg-role-dialo-1" v-model="dialogVisible" persistent max-width="400px">
    <VCard>
      ...
      <div class="d-flex justify-end px-4 pb-4">
        <VBtn color="primary" variant="outlined" class="mr-4" :disabled="loading" id="btn-role-dialog-cancel" @click="close">
          <VIcon start>mdi-close</VIcon>
          Cancelar
        </VBtn>
        <VBtn color="primary" variant="elevated" :loading="loading" id="btn-role-dialog-save" @click="save">
