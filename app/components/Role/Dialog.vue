  ...
  <VDialog id="dlg-role-dialo-1" v-model="dialogVisible" persistent max-width="400px">
    <VCard>
      <VCardTitle class="text-subtitle-1 font-weight-medium pb-2 d-flex align-center">
        ...
        {{ formTitle }}
        <VSpacer />
        <VBtn icon size="x-small" id="btn-role-dialog-close" @click="close">
      ...
      <div class="d-flex justify-end px-4 pb-4">
        <VBtn color="primary" variant="outlined" class="mr-4" :disabled="saving || loading" id="btn-role-dialog-cancel" @click="close">
          <VIcon start>mdi-close</VIcon>
          Cancelar
        </VBtn>
        <VBtn color="primary" variant="elevated" :loading="saving || loading" :disabled="saving || loading" id="btn-role-dialog-save" @click="save">
